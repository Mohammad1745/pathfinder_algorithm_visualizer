let convergentSwarm = {
    search: async ({row, column, weights, wall, startingPoint, endPoint}) => {
        ...
        while (true) {
            ...
            convergentSwarm.updateNodesWithShortestDistance(solvedNodes, unsolvedNodes, row, column, lastNode, nextNodePositions, wall, weights, biasRatio)
    ...
    updateNodesWithShortestDistance : (solvedNodes, unsolvedNodes, row, column, lastNode, nextNodePositions, wall, weights, biasRatio) => {
